...
export const BOSNIA_PRESET_CITIES: readonly Location[] = [
  ...
  { name: 'Bosanski Petrovac', lat: 44.5567, lng: 16.37 },
  ...
  { name: 'Laktaši', lat: 44.8897, lng: 17.31 },
  { name: 'Livno', lat: 43.8281, lng: 17.008 },
  ...
  { name: 'Prijedor', lat: 44.98, lng: 16.7136 },
  ...
  { name: 'Srebrenik', lat: 44.7067, lng: 18.49 },
  { name: 'Stolac', lat: 43.0844, lng: 17.96 },
  ...
  { name: 'Tešanj', lat: 44.61, lng: 17.9856 },
  { name: 'Tomislav-Grad', lat: 43.7178, lng: 17.225 },
  { name: 'Travnik', lat: 44.2264, lng: 17.658 },
  ...
  { name: 'Živinice', lat: 44.45, lng: 18.65 },
